...
class IcfConfig
{
	...
	function IcfConfig()
	{			
		$this->cfg_db_connectionString = 'mysqlt://adrianint:certeza@localhost/icfcerteza';
		$this->cfg_db_debug = false;
		$this->cfg_db_tableprefix = 'icf';
				
		$this->cfg_site_feBaseUrl = 'http://www.libreriascerteza.com/icf';
		$this->cfg_site_beBaseUrl = 'http://www.libreriascerteza.com/icf/admin';
		$this->cfg_site_beTemplateUrl = 'http://www.libreriascerteza.com/icf/admin/core/templates/default';

		$this->cfg_site_feBasePath = '/home/httpd/vhosts/libreriascerteza.com/httpdocs/icf';
		$this->cfg_site_beBasePath = '/home/httpd/vhosts/libreriascerteza.com/httpdocs/icf/admin';
