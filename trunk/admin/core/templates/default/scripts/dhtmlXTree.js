...
dhtmlXTreeObject.prototype.a12=function(dhtmlObject){
 ...
 if(this.parentObject.checkstate==1)this.treeNod.a32(false,this.parentObject);
 else this.treeNod.a32(true,this.parentObject);
 else
 ...
 var img=document.createElement("img");img.onmousedown=this.a21;
 img.border="0";
 ...
 if(this.nodeCut)
{
 ...
 if(!temp)return 0;
 if(this.nodeCut){
 if((!this.a22(this.nodeCut.parentObject.id,temp))&&(id!=this.nodeCut.parentObject.parentObject.id))
 this.a23(temp,this.nodeCut.parentObject);
 this.clearCut();
}
};
 ...
 if(this.nodeCut)
{
 ...
 dhtmlXTreeObject.prototype.a23=function(itemObject,targetObject){
 ...
 if((targetObject.XMLload==0)&&(this.XMLsource))
{
 ...
 Nodes[i]=0;
 break;}
 oldTree.a29(z.childsCount,z.childNodes);
 z.childsCount--;
 itemObject.tr=tr;
 tr.nodem=itemObject;

 itemObject.parentObject=targetObject;
 if(oldTree!=targetObject.treeNod){if(itemObject.treeNod.a26(itemObject,oldTree))return;this.a25(itemObject);};
...
dhtmlXTreeObject.prototype.a22=function(itemId,htmlObject){
 if(htmlObject.id==itemId)return 1;
 if(htmlObject.parentObject)return this.a22(itemId,htmlObject.parentObject);else return 0;
};
 
 
 
 
 dhtmlXTreeObject.prototype.a25=function(itemObject){
 ...
 this.a11(itemObject);
 this.a10(itemObject);
 for(var i=0;i<itemObject.childsCount;i++)this.a25(itemObject.childNodes[i]);
};
 
 dhtmlXTreeObject.prototype.a26=function(itemObject,oldTree){
 
 itemObject.id=this.a0Add(itemObject.id,itemObject);
 itemObject.treeNod=this;
 if(oldTree)oldTree.a0Sub(itemObject.id);
 for(var i=0;i<itemObject.childsCount;i++)
 this.a26(itemObject.childNodes[i],oldTree);
 return 0;
};
